...
from src.pretraining_callbacks import (
...
def run_training(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    positional_probe_callback = PositionalEncodingProbeCallback(
        stage="validate",
        max_tokens=8192,
        ridge_lambda=1e-3,
    )

    attribute_probe_callbacks = [
        ...
        TokenAttributeProbeCallback(attribute="beat_strength", stage="validate", max_tokens=8192, ridge_lambda=1e-3),
        TokenAttributeProbeCallback(attribute="key", stage="validate", max_tokens=8192, ridge_lambda=1e-3),
        TokenAttributeProbeCallback(attribute="chord", stage="validate", max_tokens=8192, ridge_lambda=1e-3),
    ]
    ...
    trainer = pl.Trainer(
        ...
        callbacks=[checkpoint_callback, visualization_callback, positional_probe_callback, *attribute_probe_callbacks],
