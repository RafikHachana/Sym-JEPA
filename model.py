...
# Seems that this LightningModule is from a wrapper library of PT
class Seq2SeqModule(pl.LightningModule):
  def __init__(self,
    ...
    # The part where we get the description config
    ...
    # Context size and dimensions of the tokens
    ...
    # Here we create the model from config objects
    ...
    # Embeddings for bar and position
    # Seems like this is for the embeddings that are combined with the tokens
    ...
    # Embeddings for the description functions (latent or expert)
  ...
  def decode(self, x, labels=None, bar_ids=None, position_ids=None, encoder_hidden_states=None, return_hidden=False):
    seq_len = x.size(1)
    # TODO: We really need to understand the code here
    # FIXME: Are they really passing X (input IDs) directly to the decoder? Or are input IDs something different than the input sequence?
